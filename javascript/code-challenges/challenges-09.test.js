...
const hasChildrenValues = (arr, character) => {
  for (let prop of arr) {
    if (prop.name === character && prop.children) {
      return Object.values(prop.children).length > 0 ? true : false;
    }
  }
  return false;
  // return (Object.values(character.children).length > 0 ? true : false);
